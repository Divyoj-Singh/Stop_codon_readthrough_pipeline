...
coverage_threshold_isr = 0.75
coverage_threshold_3utr = 0.25
condition = "ISR"
fold_std = 1


path_to_density = "./../../downstream_analysis_files_strict/density_filtered_genes/"+condition+"/"
if not os.path.exists(path_to_density):
    os.makedirs(path_to_density)

path_to_coverage = "./../../downstream_analysis_files_strict/coverage_filtered_genes/"+condition+"/"
if not os.path.exists(path_to_coverage):
    os.makedirs(path_to_coverage)

path_to_frame_info = "./../../downstream_analysis_files_strict/periodicity_filtered_genes/"+condition+"/"
if not os.path.exists(path_to_frame_info):
    os.makedirs(path_to_frame_info)

path_to_histogram_data = "./../../downstream_analysis_files_strict/length_dist_genes/"+condition+"/"
if not os.path.exists(path_to_histogram_data):
    os.makedirs(path_to_histogram_data)

path_to_final_RT_list = "./../../downstream_analysis_files_strict/consolidated_filtered_genes/"+condition+"/"
if not os.path.exists(path_to_final_RT_list):
    os.makedirs(path_to_final_RT_list)

path_to_RT_gene_list = "./../../downstream_analysis_files_strict/filtered_genes_frequencies/"+condition+"/"
if not os.path.exists(path_to_RT_gene_list):
    os.makedirs(path_to_RT_gene_list)

path_to_CDS_stats = "./../../downstream_analysis_files_strict/cds_stats/"
if not os.path.exists(path_to_CDS_stats):
    os.makedirs(path_to_CDS_stats)

path_to_heatmaps = "./../../downstream_analysis_files_strict/heatmaps/"+condition+"/"
...
path_of_RT_graphs = "./../../downstream_analysis_files_strict/gene_profiles/"+condition+"/"
